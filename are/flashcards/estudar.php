  ...
  <div class="table-div">
      <table class="table">
            ...
            <tbody id="tabela-flashcards">
                <?php
                //estudar
                $hora_dif = "SELECT * FROM flashcards WHERE timestampdiff (HOUR, hora ,CURRENT_DATE)+14 > -24 AND $id = usuario_id";
                try{
                ...
                while($row_msg_count = $resultado_msg_cont->fetch(PDO::FETCH_ASSOC)) {                  
                          ...
                          echo "<td>
                            <a id='verde' href='facil.php?id=$row_msg_count[id_flashcard]'>Acertei</a>
                            <a id='amarelo' href='medio.php?id=$row_msg_count[id_flashcard]'>Difícil</a>
                            <a id='vermelho' href='dificil.php?id=$row_msg_count[id_flashcard]'>Errei</a>
                          </td>";
                          echo "</tr>";                    
                     }                         
